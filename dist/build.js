...
exports.default = {
    data: function data() {
        return {
            crackers: (0, _big2.default)(1E21),
            totalCrackers: (0, _big2.default)(0),
            clicks: (0, _big2.default)(0),
            cps: (0, _big2.default)(0),
            clickPower: (0, _big2.default)(1),

            buildings: [{ name: 'Finger', baseCost: (0, _big2.default)(15), baseCps: 0.1, currentCps: 0.1, description: "Growing extra fingers will allow you to click more often. Autoclicks once every 10 seconds.", showAt: 0, owned: 0 }, { name: 'Toddler', baseCost: (0, _big2.default)(100), baseCps: 1, currentCps: 1, description: "These toddlers will eat crackers if you tell them they're cookies.", showAt: (0, _big2.default)(0), owned: 0 }, { name: 'Kosher Bakery', baseCost: (0, _big2.default)(1100), baseCps: 8, currentCps: 8, description: "These guys seem to know what they're doing.", showAt: (0, _big2.default)(15), owned: 0 }, { name: 'Non-Kosher Bakery', baseCost: (0, _big2.default)(12000), baseCps: 47, currentCps: 47, description: "These guys don't follow the rules!", showAt: (0, _big2.default)(100), owned: 0 }, { name: 'Tea Club', baseCost: (0, _big2.default)(130000), baseCps: 260, currentCps: 260, description: "These ladies LOVE crackers with their tea", showAt: (0, _big2.default)(1100), owned: 0 }, { name: 'Cracker Factory', baseCost: (0, _big2.default)(1.4E6), baseCps: 1400, currentCps: 1400, description: "Seems only logical", showAt: (0, _big2.default)(12000), owned: 0 }, { name: 'Cracker Warehouse', baseCost: (0, _big2.default)(20E6), baseCps: 7800, currentCps: 7800, description: "We need more space to store all these crackers!", showAt: (0, _big2.default)(130000), owned: 0 }],
            ...
            // finger (cursor)
            { type: 'Finger', name: 'Double Tap', needed: 1, cost: (0, _big2.default)(100), multiplier: 2, description: 'Tap faster', active: false }, { type: 'Finger', name: 'Quattro Tap', needed: 1, cost: (0, _big2.default)(500), multiplier: 2, description: 'Tap faster!', active: false }, { type: 'Finger', name: 'Mega Tap', needed: 10, cost: (0, _big2.default)(10000), multiplier: 2, description: 'Tap even faster!!', active: false }, { type: 'Finger', name: 'Middle Finger', needed: 20, cost: (0, _big2.default)(100000), addition: 0.1, description: 'Put that thing away.', active: false }, { type: 'Finger', name: 'Double Middle Finger', needed: 40, cost: (0, _big2.default)(10E6), addition: 0.5, description: 'Put those away.', active: false }, { type: 'Finger', name: 'Extra Middle Fingers', needed: 80, cost: (0, _big2.default)(100E6), addition: 5, description: "Now that's just rude.", active: false }, { type: 'Finger', name: 'Super Finger', needed: 120, cost: (0, _big2.default)(1E9), addition: 50, description: "No decorum at all.", active: false }, { type: 'Finger', name: 'Super Duper Finger', needed: 160, cost: (0, _big2.default)(10E9), addition: 500, description: "Need Description", active: false }, { type: 'Finger', name: 'Mega Finger', needed: 200, cost: (0, _big2.default)(10E12), addition: 5000, description: "Need Description", active: false }, { type: 'Finger', name: 'Turbo Finger', needed: 240, cost: (0, _big2.default)(100E12), addition: 50000, description: "Need Description", active: false }, { type: 'Finger', name: 'Ultra Finger', needed: 280, cost: (0, _big2.default)(1E12), addition: 500000, description: "Need Description", active: false }, { type: 'Finger', name: 'Ultimate Finger', needed: 320, cost: (0, _big2.default)(10E15), addition: 5000000, description: "Need Description", active: false },

            // toddler (grandma)
            { type: 'Toddler', name: 'Timeout', needed: 1, cost: (0, _big2.default)(1000), multiplier: 2, description: 'These toddlers need to learn some discipline', active: false }, { type: 'Toddler', name: 'Daycare', needed: 5, cost: (0, _big2.default)(5000), multiplier: 2, description: 'Finally, some me time!', active: false }, { type: 'Toddler', name: 'Play Date', needed: 25, cost: (0, _big2.default)(50000), multiplier: 2, description: 'An active social life is good for productivity', active: false }, { type: 'Toddler', name: 'ADHD Meds', needed: 50, cost: (0, _big2.default)(5E6), multiplier: 2, description: "That's better...", active: false }, { type: 'Toddler', name: 'Jack', needed: 100, cost: (0, _big2.default)(500E6), multiplier: 2, description: "Like that movie?", active: false }, { type: 'Toddler', name: 'Jack & Jill', needed: 150, cost: (0, _big2.default)(50E9), multiplier: 2, description: "The worst Adam Sandler movie", active: false }, { type: 'Toddler', name: 'Need Name', needed: 200, cost: (0, _big2.default)(50E12), multiplier: 2, description: "Need Description", active: false }, { type: 'Toddler', name: 'Need Name', needed: 250, cost: (0, _big2.default)(50E15), multiplier: 2, description: "Need Description", active: false },

            // kosher bakery (farm)
            { type: 'Kosher Bakery', name: 'Torah', needed: 1, cost: (0, _big2.default)(11000), multiplier: 2, description: 'Got to follow the rules', active: false }, { type: 'Kosher Bakery', name: 'Another Torah', needed: 5, cost: (0, _big2.default)(55000), multiplier: 2, description: 'More to go around', active: false }, { type: 'Kosher Bakery', name: 'Rabbi', needed: 25, cost: (0, _big2.default)(550000), multiplier: 2, description: "This rabbi doesn't come cheap", active: false }, { type: 'Kosher Bakery', name: 'Rabbi Council', needed: 50, cost: (0, _big2.default)(55E6), multiplier: 2, description: "These rabbis don't come cheap", active: false }, { type: 'Kosher Bakery', name: 'Passover Bonus', needed: 100, cost: (0, _big2.default)(5.5E9), multiplier: 2, description: "What does that even mean?", active: false }, { type: 'Kosher Bakery', name: 'Need Name', needed: 150, cost: (0, _big2.default)(550E9), multiplier: 2, description: "Need Description", active: false }, { type: 'Kosher Bakery', name: 'Need Name', needed: 200, cost: (0, _big2.default)(550E12), multiplier: 2, description: "Need Description", active: false }, { type: 'Kosher Bakery', name: 'Need Name', needed: 250, cost: (0, _big2.default)(550E15), multiplier: 2, description: "Need Description", active: false },

            // non-kosher bakery (mine)
            { type: 'Non-Kosher Bakery', name: 'Knockoff Torah', needed: 1, cost: (0, _big2.default)(120000), multiplier: 2, description: "This doesn't seem legit...", active: false }, { type: 'Non-Kosher Bakery', name: 'Another Knockoff Torah', needed: 5, cost: (0, _big2.default)(600000), multiplier: 2, description: "??", active: false }, { type: 'Non-Kosher Bakery', name: 'Fake Rabbi', needed: 25, cost: (0, _big2.default)(6E6), multiplier: 2, description: "I don't think his beard is real", active: false }, { type: 'Non-Kosher Bakery', name: 'Fake Rabbi Council', needed: 50, cost: (0, _big2.default)(600E6), multiplier: 2, description: "I have a bad feeling about this", active: false }, { type: 'Non-Kosher Bakery', name: 'Fake Passover Bonus', needed: 100, cost: (0, _big2.default)(60E9), multiplier: 2, description: "What does that even mean?!", active: false }, { type: 'Non-Kosher Bakery', name: 'Need Name', needed: 150, cost: (0, _big2.default)(6E12), multiplier: 2, description: "Need Description", active: false }, { type: 'Non-Kosher Bakery', name: 'Need Name', needed: 200, cost: (0, _big2.default)(6E15), multiplier: 2, description: "Need Description", active: false }, { type: 'Non-Kosher Bakery', name: 'Need Name', needed: 250, cost: (0, _big2.default)(6E18), multiplier: 2, description: "Need Description", active: false },

            // tea club (factory)
            { type: 'Tea Club', name: 'Strumpets', needed: 1, cost: (0, _big2.default)(1.3E6), multiplier: 2, description: "What are we, savages?", active: false }, { type: 'Tea Club', name: 'Valet', needed: 5, cost: (0, _big2.default)(6.5E6), multiplier: 2, description: "I'm too rich to park my car", active: false }, { type: 'Tea Club', name: 'Servant', needed: 25, cost: (0, _big2.default)(65E6), multiplier: 2, description: "It's not technically slavery!", active: false }, { type: 'Tea Club', name: 'Free trade tea', needed: 50, cost: (0, _big2.default)(6.5E9), multiplier: 2, description: "I feel so much better about this", active: false }, { type: 'Tea Club', name: 'Slavery tea', needed: 100, cost: (0, _big2.default)(650E9), multiplier: 2, description: "Suffering tastes better", active: false }, { type: 'Tea Club', name: 'Need Name', needed: 150, cost: (0, _big2.default)(65E12), multiplier: 2, description: "Need Description", active: false }, { type: 'Tea Club', name: 'Need Name', needed: 200, cost: (0, _big2.default)(65E15), multiplier: 2, description: "Need Description", active: false }, { type: 'Tea Club', name: 'Need Name', needed: 250, cost: (0, _big2.default)(65E18), multiplier: 2, description: "Need Description", active: false },

            // cracker factory (bank)
            { type: 'Cracker Factory', name: 'Strumpets', needed: 1, cost: (0, _big2.default)(14E6), multiplier: 2, description: "What are we, savages?", active: false }, { type: 'Cracker Factory', name: 'Valet', needed: 5, cost: (0, _big2.default)(70E6), multiplier: 2, description: "I'm too rich to park my car", active: false }, { type: 'Cracker Factory', name: 'Servant', needed: 25, cost: (0, _big2.default)(700E6), multiplier: 2, description: "It's not technically slavery!", active: false }, { type: 'Cracker Factory', name: 'Free trade tea', needed: 50, cost: (0, _big2.default)(70E9), multiplier: 2, description: "I feel so much better about this", active: false }, { type: 'Cracker Factory', name: 'Slavery tea', needed: 100, cost: (0, _big2.default)(7E12), multiplier: 2, description: "Suffering tastes better", active: false }, { type: 'Cracker Factory', name: 'Need Name', needed: 150, cost: (0, _big2.default)(700E12), multiplier: 2, description: "Need Description", active: false }, { type: 'Cracker Factory', name: 'Need Name', needed: 200, cost: (0, _big2.default)(700E15), multiplier: 2, description: "Need Description", active: false }, { type: 'Cracker Factory', name: 'Need Name', needed: 250, cost: (0, _big2.default)(700E18), multiplier: 2, description: "Need Description", active: false },
