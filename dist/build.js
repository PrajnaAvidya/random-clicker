...
exports.default = {
    ...
    methods: {
        ...
        buildingCost: function buildingCost(building) {
            ...
            return (0, _big2.default)(Math.ceil(building.baseCost * (Math.pow(1.15, building.owned + amount) - Math.pow(1.15, building.owned)) / 0.15));
        },
