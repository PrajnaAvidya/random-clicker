...
Component.options.__file = "/Users/rafiq/Sites/cracker-clicker/src/game.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0ce883ea", Component.options)
  } else {
    hotAPI.reload("data-v-0ce883ea", Component.options)
  }
...
exports.default = {
    data: function data() {
        return {
            ...
            upgrades: [
            // production
            { type: 'Cracker', name: 'Store Brand Crackers', needed: (0, _big2.default)(50000), cost: (0, _big2.default)(999999), multiplier: 1.01, description: 'Meh', active: false }, { type: 'Cracker', name: 'Fancy Store Crackers', needed: (0, _big2.default)(250000), cost: (0, _big2.default)(5E6), multiplier: 1.01, description: 'Ok I guess', active: false }, { type: 'Cracker', name: 'Rye Crackers', needed: (0, _big2.default)(500000), cost: (0, _big2.default)(10E6), multiplier: 1.01, description: 'Better than cardboard', active: false }, { type: 'Cracker', name: 'Sugared Crackers', needed: (0, _big2.default)(2.5E6), cost: (0, _big2.default)(50E6), multiplier: 1.01, description: 'Gross?', active: false }, { type: 'Cracker', name: 'Saltine Crackers', needed: (0, _big2.default)(5E6), cost: (0, _big2.default)(100E6), multiplier: 1.01, description: 'That seems reasonable', active: false }, { type: 'Cracker', name: 'Need Name', needed: (0, _big2.default)(25E6), cost: (0, _big2.default)(500E6), multiplier: 1.02, description: 'Need Description', active: false }, { type: 'Cracker', name: 'Need Name', needed: (0, _big2.default)(50E6), cost: (0, _big2.default)(1E9), multiplier: 1.02, description: 'Need Description', active: false }, { type: 'Cracker', name: 'Need Name', needed: (0, _big2.default)(250E6), cost: (0, _big2.default)(5E9), multiplier: 1.02, description: 'Need Description', active: false }, { type: 'Cracker', name: 'Need Name', needed: (0, _big2.default)(500E6), cost: (0, _big2.default)(10E9), multiplier: 1.02, description: 'Need Description', active: false }, { type: 'Cracker', name: 'Need Name', needed: (0, _big2.default)(2.5E9), cost: (0, _big2.default)(50E9), multiplier: 1.02, description: 'Need Description', active: false },
            // 4% etc

            { type: 'Cursor', name: 'Double Tap', needed: 1, cost: (0, _big2.default)(100), multiplier: 2, description: 'Tap faster', active: false }, { type: 'Cursor', name: 'Quattro Tap', needed: 1, cost: (0, _big2.default)(500), multiplier: 2, description: 'Tap faster!', active: false }, { type: 'Cursor', name: 'Mega Tap', needed: 10, cost: (0, _big2.default)(10000), multiplier: 2, description: 'Tap even faster!!', active: false }, { type: 'Cursor', name: 'Middle Cursor', needed: 20, cost: (0, _big2.default)(100000), addition: 0.1, description: 'Put that thing away.', active: false }, { type: 'Cursor', name: 'Double Middle Cursor', needed: 40, cost: (0, _big2.default)(10E6), addition: 0.5, description: 'Put those away.', active: false }, { type: 'Cursor', name: 'Extra Middle Cursors', needed: 80, cost: (0, _big2.default)(100E6), addition: 5, description: "Now that's just rude.", active: false }, { type: 'Cursor', name: 'Super Cursor', needed: 120, cost: (0, _big2.default)(1E9), addition: 50, description: "No decorum at all.", active: false }, { type: 'Cursor', name: 'Super Duper Cursor', needed: 160, cost: (0, _big2.default)(10E9), addition: 500, description: "Need Description", active: false }, { type: 'Cursor', name: 'Mega Cursor', needed: 200, cost: (0, _big2.default)(10E12), addition: 5000, description: "Need Description", active: false }, { type: 'Cursor', name: 'Turbo Cursor', needed: 240, cost: (0, _big2.default)(100E12), addition: 50000, description: "Need Description", active: false }, { type: 'Cursor', name: 'Ultra Cursor', needed: 280, cost: (0, _big2.default)(1E12), addition: 500000, description: "Need Description", active: false }, { type: 'Cursor', name: 'Ultimate Cursor', needed: 320, cost: (0, _big2.default)(10E15), addition: 5000000, description: "Need Description", active: false }, { type: 'Grandma', name: 'Timeout', needed: 1, cost: (0, _big2.default)(1000), multiplier: 2, description: 'These toddlers need to learn some discipline', active: false }, { type: 'Grandma', name: 'Daycare', needed: 5, cost: (0, _big2.default)(5000), multiplier: 2, description: 'Finally, some me time!', active: false }, { type: 'Grandma', name: 'Play Date', needed: 25, cost: (0, _big2.default)(50000), multiplier: 2, description: 'An active social life is good for productivity', active: false }, { type: 'Grandma', name: 'ADHD Meds', needed: 50, cost: (0, _big2.default)(5E6), multiplier: 2, description: "That's better...", active: false }, { type: 'Grandma', name: 'Jack', needed: 100, cost: (0, _big2.default)(500E6), multiplier: 2, description: "Like that movie?", active: false }, { type: 'Grandma', name: 'Jack & Jill', needed: 150, cost: (0, _big2.default)(50E9), multiplier: 2, description: "The worst Adam Sandler movie", active: false }, { type: 'Grandma', name: 'Need Name', needed: 200, cost: (0, _big2.default)(50E12), multiplier: 2, description: "Need Description", active: false }, { type: 'Grandma', name: 'Need Name', needed: 250, cost: (0, _big2.default)(50E15), multiplier: 2, description: "Need Description", active: false }, { type: 'Farm', name: 'Torah', needed: 1, cost: (0, _big2.default)(11000), multiplier: 2, description: 'Got to follow the rules', active: false }, { type: 'Farm', name: 'Another Torah', needed: 5, cost: (0, _big2.default)(55000), multiplier: 2, description: 'More to go around', active: false }, { type: 'Farm', name: 'Rabbi', needed: 25, cost: (0, _big2.default)(550000), multiplier: 2, description: "This rabbi doesn't come cheap", active: false }, { type: 'Farm', name: 'Rabbi Council', needed: 50, cost: (0, _big2.default)(55E6), multiplier: 2, description: "These rabbis don't come cheap", active: false }, { type: 'Farm', name: 'Passover Bonus', needed: 100, cost: (0, _big2.default)(5.5E9), multiplier: 2, description: "What does that even mean?", active: false }, { type: 'Farm', name: 'Need Name', needed: 150, cost: (0, _big2.default)(550E9), multiplier: 2, description: "Need Description", active: false }, { type: 'Farm', name: 'Need Name', needed: 200, cost: (0, _big2.default)(550E12), multiplier: 2, description: "Need Description", active: false }, { type: 'Farm', name: 'Need Name', needed: 250, cost: (0, _big2.default)(550E15), multiplier: 2, description: "Need Description", active: false }, { type: 'Mine', name: 'Knockoff Torah', needed: 1, cost: (0, _big2.default)(120000), multiplier: 2, description: "This doesn't seem legit...", active: false }, { type: 'Mine', name: 'Another Knockoff Torah', needed: 5, cost: (0, _big2.default)(600000), multiplier: 2, description: "??", active: false }, { type: 'Mine', name: 'Fake Rabbi', needed: 25, cost: (0, _big2.default)(6E6), multiplier: 2, description: "I don't think his beard is real", active: false }, { type: 'Mine', name: 'Fake Rabbi Council', needed: 50, cost: (0, _big2.default)(600E6), multiplier: 2, description: "I have a bad feeling about this", active: false }, { type: 'Mine', name: 'Fake Passover Bonus', needed: 100, cost: (0, _big2.default)(60E9), multiplier: 2, description: "What does that even mean?!", active: false }, { type: 'Mine', name: 'Need Name', needed: 150, cost: (0, _big2.default)(6E12), multiplier: 2, description: "Need Description", active: false }, { type: 'Mine', name: 'Need Name', needed: 200, cost: (0, _big2.default)(6E15), multiplier: 2, description: "Need Description", active: false }, { type: 'Mine', name: 'Need Name', needed: 250, cost: (0, _big2.default)(6E18), multiplier: 2, description: "Need Description", active: false }, { type: 'Factory', name: 'Strumpets', needed: 1, cost: (0, _big2.default)(1.3E6), multiplier: 2, description: "What are we, savages?", active: false }, { type: 'Factory', name: 'Valet', needed: 5, cost: (0, _big2.default)(6.5E6), multiplier: 2, description: "I'm too rich to park my car", active: false }, { type: 'Factory', name: 'Servant', needed: 25, cost: (0, _big2.default)(65E6), multiplier: 2, description: "It's not technically slavery!", active: false }, { type: 'Factory', name: 'Free trade tea', needed: 50, cost: (0, _big2.default)(6.5E9), multiplier: 2, description: "I feel so much better about this", active: false }, { type: 'Factory', name: 'Slavery tea', needed: 100, cost: (0, _big2.default)(650E9), multiplier: 2, description: "Suffering tastes better", active: false }, { type: 'Factory', name: 'Need Name', needed: 150, cost: (0, _big2.default)(65E12), multiplier: 2, description: "Need Description", active: false }, { type: 'Factory', name: 'Need Name', needed: 200, cost: (0, _big2.default)(65E15), multiplier: 2, description: "Need Description", active: false }, { type: 'Factory', name: 'Need Name', needed: 250, cost: (0, _big2.default)(65E18), multiplier: 2, description: "Need Description", active: false }, { type: 'Bank', name: 'Strumpets', needed: 1, cost: (0, _big2.default)(14E6), multiplier: 2, description: "What are we, savages?", active: false }, { type: 'Bank', name: 'Valet', needed: 5, cost: (0, _big2.default)(70E6), multiplier: 2, description: "I'm too rich to park my car", active: false }, { type: 'Bank', name: 'Servant', needed: 25, cost: (0, _big2.default)(700E6), multiplier: 2, description: "It's not technically slavery!", active: false }, { type: 'Bank', name: 'Free trade tea', needed: 50, cost: (0, _big2.default)(70E9), multiplier: 2, description: "I feel so much better about this", active: false }, { type: 'Bank', name: 'Slavery tea', needed: 100, cost: (0, _big2.default)(7E12), multiplier: 2, description: "Suffering tastes better", active: false }, { type: 'Bank', name: 'Need Name', needed: 150, cost: (0, _big2.default)(700E12), multiplier: 2, description: "Need Description", active: false }, { type: 'Bank', name: 'Need Name', needed: 200, cost: (0, _big2.default)(700E15), multiplier: 2, description: "Need Description", active: false }, { type: 'Bank', name: 'Need Name', needed: 250, cost: (0, _big2.default)(700E18), multiplier: 2, description: "Need Description", active: false }, { type: 'Temple', name: 'Need Name', needed: 1, cost: (0, _big2.default)(200E6), multiplier: 2, description: "Need Description", active: false }, { type: 'Temple', name: 'Need Name', needed: 5, cost: (0, _big2.default)(1E9), multiplier: 2, description: "Need Description", active: false }, { type: 'Temple', name: 'Need Name', needed: 25, cost: (0, _big2.default)(10E9), multiplier: 2, description: "Need Description", active: false }, { type: 'Temple', name: 'Need Name', needed: 50, cost: (0, _big2.default)(1E12), multiplier: 2, description: "Need Description", active: false }, { type: 'Temple', name: 'Need Name', needed: 100, cost: (0, _big2.default)(100E12), multiplier: 2, description: "Need Description", active: false }, { type: 'Temple', name: 'Need Name', needed: 150, cost: (0, _big2.default)(10E15), multiplier: 2, description: "Need Description", active: false }, { type: 'Temple', name: 'Need Name', needed: 200, cost: (0, _big2.default)(10E18), multiplier: 2, description: "Need Description", active: false }, { type: 'Temple', name: 'Need Name', needed: 250, cost: (0, _big2.default)(10E21), multiplier: 2, description: "Need Description", active: false }, { type: 'Wizard Tower', name: 'Need Name', needed: 1, cost: (0, _big2.default)(3.3E9), multiplier: 2, description: "Need Description", active: false }, { type: 'Wizard Tower', name: 'Need Name', needed: 5, cost: (0, _big2.default)(16.5E9), multiplier: 2, description: "Need Description", active: false }, { type: 'Wizard Tower', name: 'Need Name', needed: 25, cost: (0, _big2.default)(165E9), multiplier: 2, description: "Need Description", active: false }, { type: 'Wizard Tower', name: 'Need Name', needed: 50, cost: (0, _big2.default)(16.5E12), multiplier: 2, description: "Need Description", active: false }, { type: 'Wizard Tower', name: 'Need Name', needed: 100, cost: (0, _big2.default)(1.65E15), multiplier: 2, description: "Need Description", active: false }, { type: 'Wizard Tower', name: 'Need Name', needed: 150, cost: (0, _big2.default)(165E15), multiplier: 2, description: "Need Description", active: false }, { type: 'Wizard Tower', name: 'Need Name', needed: 200, cost: (0, _big2.default)(165E18), multiplier: 2, description: "Need Description", active: false }, { type: 'Wizard Tower', name: 'Need Name', needed: 250, cost: (0, _big2.default)(165E21), multiplier: 2, description: "Need Description", active: false }],
    ...
    methods: {
        ...
        recalculateCps: function recalculateCps() {
            ...
            this.ownedBuildings().forEach(function (building) {
                var buildingCps = building.baseCps.times(vm.upgradeMultiplier(building.name));
        ...
        otherBuildingCount: function otherBuildingCount(buildingName) {
            var buildingCount = 0;
        ...
        ownedBuildings: function ownedBuildings() {
        ...
        // upgrades
        canBuyUpgrade: function canBuyUpgrade(upgrade) {
        ...
        buyUpgrade: function buyUpgrade(upgrade) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "total-crackers"
  }, [_c('h1', [_vm._v(_vm._s(_vm._f("crackers")(_vm.crackers)) + " crackers")])]), _vm._v(" "), _c('span', {
    staticClass: "crackers-per-second"
  }, [_c('h2', [_vm._v("Per second: " + _vm._s(_vm._f("round")(_vm.cps)))])]), _vm._v(" "), _c('span', {
    staticClass: "crackers-per-click"
  }, [_c('h3', [_vm._v("Per click: " + _vm._s(_vm._f("crackers")(_vm.clickPower)))])])]), _vm._v(" "), _c('div', {
    staticClass: "row cracker"
  }, [_c('img', {
    attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0ce883ea", module.exports)
  }
}
...
if(false) {
 ...
 if(!content.locals) {
   module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0ce883ea\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./game.vue", function() {
     var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0ce883ea\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./game.vue");
